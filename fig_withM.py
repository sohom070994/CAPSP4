...
ax1.set_xlabel(r'Allowable modifications ($M$)', fontsize=20, fontfamily="Times New Roman")
...
plt.savefig('fig8b_withM.pdf', format='pdf', dpi=300, bbox_inches='tight')
...
ax3.set_xlabel(r'Allowable modifications ($M$)', fontsize=20)
ax3.set_ylabel('Weighted access time', fontsize=20, color='black')
ax4.set_ylabel(r'Percentage improvment (\%)', fontsize=20, color='black')
...
plt.savefig('fig8a_withM.pdf', format='pdf', dpi=300, bbox_inches='tight')
